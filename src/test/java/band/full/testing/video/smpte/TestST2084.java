...
public class TestST2084 {
    ...
    public void checkOETF() {
        assertEquals(0.0, PQ.oetf(-MAX_VALUE));
        assertEquals(0.0, PQ.oetf(-1.0));
        assertEquals(0.0, PQ.oetf(0.0), 1e-6);
        assertEquals(1.0, PQ.oetf(1.0));
    ...
    public void checkEOTF() {
        assertEquals(0.0, PQ.eotf(-MAX_VALUE));
        assertEquals(0.0, PQ.eotf(-1.0));
        assertEquals(0.0, PQ.eotf(0.0));
        assertEquals(92.24570899406527 / L_MAX, PQ.eotf(0.5), 1e-14);
        assertEquals(1.0, PQ.eotf(1.0));
        assertEquals(7e17, PQ.eotf(1.99), 2e16);
        assertEquals(POSITIVE_INFINITY, PQ.eotf(2.0));
        assertEquals(POSITIVE_INFINITY, PQ.eotf(MAX_VALUE));
    }

    /** Symmetry in working range */
    @Test
    public void symmetry() {
        assertEquals(0.0, PQ.eotf(PQ.oetf(0.0)));
        ...
        assertEquals(1.0, PQ.eotf(PQ.oetf(1.0)));
    }
}
