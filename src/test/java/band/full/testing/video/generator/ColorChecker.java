 ...
 * @see <a href="http://www.babelcolor.com/colorchecker.htm"> ColorChecker @
 *      babelcolor.com</a>
 */
public class ColorChecker {
     ...
     *      ColorChecker (“Macbeth”) Chart @ poynton.ca</a>
     */
    public static final List<List<String>> CLASSIC_24_NAMES = List.of(
            List.of("dark skin", "orange", "blue", "white"),
            List.of("light skin", "purplish blue", "green", "neutral 8"),
            List.of("blue sky", "moderate red", "red", "neutral 6.5"),
            List.of("foliage", "purple", "yellow", "neutral 5"),
            List.of("blue flower", "yellow green", "magenta", "neutral 3.5"),
            List.of("bluish green", "orange yellow", "cyan", "black"));
